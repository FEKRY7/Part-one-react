...
import info from './photo2/info.png'
...
const Contact = () => {
  useEffect(()=>{
    document.title=`Bistro Bliss Contact` 
   })
  return (
    <Fragment>
         <Scroll/>
...
<div className="tatristanx">
<div data-aos="zoom-in-up">
    <div className="mnstenx">
      <h1 className="textastanx">Contact Us</h1>
      <p className="pagestanx">We consider all the drivers of change gives you the components you need to change to create a truly happens.</p>
    </div>
</div>
    <form className="bagerformx">
    <div className="contenrtotl2x">
    <div className="conterx3x">
    <div className="contNamex">
    <label>Name</label>
    </div>
    <input type="text" id="namex" name="username" placeholder="Enter your Name"/>
    </div>
    <div className="conterx4x">
    <div className="contPhonex">
    <label>Email</label>
    </div>
    <input type="email" id="email" name="email" placeholder="Enter your Email"/>
    </div>
    </div>
    <div className="contenrtotl3x">
    <div className="conterx5x">
    <div className="contTotalx">
    <label>Subject</label>
    </div>
    <input type="text" name="Subject" id="Subject" placeholder="1 Person"/>
    </div>
    <div className="conterx6x">
    <div className="Message">
    <label>Message</label>
    </div>
    <textarea id="message" name="message" placeholder="Write yor Message.."></textarea>
    </div>
    </div>
    <div className="conter7x">
    <button className="contButtonx">Send</button>
    </div>
   </form>
   </div>
