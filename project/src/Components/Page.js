...
import CaKexz from './photo2/cards (1).png'
import Drin from './photo2/img (2).png'
import MainD from './photo2/Mask group (1).png'
import Brea from './photo2/cards.png'
...
const Page = () => {
  useEffect(()=>{
    document.title=`Bistro Bliss Page` 
   })
  return (
   <Fragment>
            <Scroll/>
...
<svg viewBox="0 0 16 16" className="socialSvg whatsappSvg"> <path d="M13.601 2.326A7.854 7.854 0 0 0 7.994 0C3.627 0 .068 3.558.064 7.926c0 1.399.366 2.76 1.057 3.965L0 16l4.204-1.102a7.933 7.933 0 0 0 3.79.965h.004c4.368 0 7.926-3.558 7.93-7.93A7.898 7.898 0 0 0 13.6 2.326zM7.994 14.521a6.573 6.573 0 0 1-3.356-.92l-.24-.144-2.494.654.666-2.433-.156-.251a6.56 6.56 0 0 1-1.007-3.505c0-3.626 2.957-6.584 6.591-6.584a6.56 6.56 0 0 1 4.66 1.931 6.557 6.557 0 0 1 1.928 4.66c-.004 3.639-2.961 6.592-6.592 6.592zm3.615-4.934c-.197-.099-1.17-.578-1.353-.646-.182-.065-.315-.099-.445.099-.133.197-.513.646-.627.775-.114.133-.232.148-.43.05-.197-.1-.836-.308-1.592-.985-.59-.525-.985-1.175-1.103-1.372-.114-.198-.011-.304.088-.403.087-.088.197-.232.296-.346.1-.114.133-.198.198-.33.065-.134.034-.248-.015-.347-.05-.099-.445-1.076-.612-1.47-.16-.389-.323-.335-.445-.34-.114-.007-.247-.007-.38-.007a.729.729 0 0 0-.529.247c-.182.198-.691.677-.691 1.654 0 .977.71 1.916.81 2.049.098.133 1.394 2.132 3.383 2.992.47.205.84.326 1.129.418.475.152.904.129 1.246.08.38-.058 1.171-.48 1.338-.943.164-.464.164-.86.114-.943-.049-.084-.182-.133-.38-.232z"></path> </svg>
  ...
  <div className='tolams'>
  <div data-aos="zoom-in-up">
    <div className='fosfat'>
    <h1 className='mangnez'>Our Blog & Articles</h1>
    <p className='sany'>We consider all the drivers of change gives you the components you need to change to create a truly happens.</p>
    </div>
  </div>
    <div className='sony'>
    <div data-aos="zoom-in-up">
    <img src={CaKexz} className="CaKexz" alt="logo" />
    </div>
    </div>
  </div>
  <div className='titancs'>
      <div className='botes'>
      <h1 className='shebse'>The secret tips & tricks to prepare a perfect burger & pizza for our customers</h1>
      <div data-aos="zoom-in-up">
    <img src={MainD} className="poster" alt="logo" />
      </div>
      </div>
      <div className='foster'>
        <h1 className='shoster'>What do you need to prepare a home-made burger?</h1>
        <p className='caster'>Creating the perfect burger and pizza is an art, combining ingredients, techniques, and passion to craft dishes that truly delight the palate. Today, we'll unveil some closely guarded secrets and insider tips for mastering these beloved staples of the culinary world.</p>
        <p className='master'>1.Quality Beef: The heart of a perfect burger is top-notch beef. Opt for fresh, high-quality ground beef with a fat content of about 20% for the juiciest, most flavorful results.</p>
<p className='master'>2.Seasoning: Simplicity is key here. A generous pinch of salt and black pepper just before cooking will enhance the beef's natural flavors without overshadowing them.</p>
<p className='master'>3.Don’t Overwork the Meat: When forming your patties, be gentle. Overworking the meat can lead to dense, tough burgers. You want a patty that's firm enough to hold together, but not compressed.</p>
        <p className='master'>4.Cooking: High heat is crucial. Whether you're grilling or pan-searing, make sure your cooking surface is hot enough to form a nice crust on the patty, sealing in those delicious juices.</p>
        <p className='master'>5.Resting: Allow your cooked burgers to rest for a few minutes before serving. This lets the juices redistribute throughout the patty, ensuring a moist and flavorfu</p>
        <h1 className='pasdolfa'>What are the right ingredients to make it delicious?</h1>
        <p className='narcezer'>Creating the perfect burger and pizza is an art, combining ingredients, techniques, and passion to craft dishes that truly delight the palate. Today, we'll unveil some closely guarded secrets and insider tips for mastering these beloved staples of the culinary world.</p>
        <p className='marces'>1.Quality Beef: The heart of a perfect burger is top-notch beef. Opt for fresh, high-quality ground beef with a fat content of about 20% for the juiciest, most flavorful results.</p>
        <p className='marces'>2.Seasoning: Simplicity is key here. A generous pinch of salt and black pepper just before cooking will enhance the beef's natural flavors without overshadowing them.</p>
        <p className='marces'>3.Don’t Overwork the Meat: When forming your patties, be gentle. Overworking the meat can lead to dense, tough burgers. You want a patty that's firm enough to hold together, but not compressed.</p>
        <p className='marces'>4.Cooking: High heat is crucial. Whether you're grilling or pan-searing, make sure your cooking surface is hot enough to form a nice crust on the patty, sealing in those delicious juices.</p>
        <p className='marces'>5.Resting: Allow your cooked burgers to rest for a few minutes before serving. This lets the juices redistribute throughout the patty, ensuring a moist and flavorful bite.</p>
      </div>
      <div className='shancez'>
      <div data-aos="zoom-in-up">
      <img src={Drin} className="potgrefers" alt="logo" />
      </div>
      <h1 className='masteryols'>What are the right ingredients to make it delicious?</h1>
      <p className='volves'>Proin faucibus nec mauris a sodales, sed elementum mi tincidunt. Sed eget viverra egestas nisi in consequat. Fusce sodales augue a accumsa Cras sollicitudin, le ligula, porttitor eu, consequat vitae, eleifend ac, enim. Lorem ipsum dolor sit amet, consectetur adipiscing elit lobortis arcu enim urna adipiscing praesent velit viverra sit semper lorem eu cursus ve of all hendrerit elementum morbi curabitur etiam nibh justo, lorem aliquet donec sed sit mi dignissim at ante massa mattis magna sit amet purus gravida quis blandit turpis..</p>
      </div>
  </div>
  <div className='colcos'>
          <div className='bolobs'>
          <h1 className='olimbick'>Read More Articles</h1>
           <p className='fldifia'>We consider all the drivers of change gives you the components you need to change to create a truly happens.</p>
          </div>
          <div className='malteryo'>
          <div data-aos="zoom-in-up">
          <img src={Brea} className="bolinost" alt="logo" />
          </div>
          </div>
      </div>
